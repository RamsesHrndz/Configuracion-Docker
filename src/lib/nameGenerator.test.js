...
describe('generateName', () => {
  ...
  it('should include a known suffix for the given class', () => {
    const suffixes = ['the Strong', 'Shieldbearer', 'of the Blade', 'Ironfist', 'Battleborn', 'the Relentless'];
    const name = generateName('Human', 'Warrior');
  ...
  it('should work for Elf Mage', () => {
    ...
    const mageSuffixes = ['Fireweaver', 'Arclight', 'the Spellbound', 'the Mystic', 'Stormbringer', 'Voidwalker'];
  ...
  it('should work for Dwarf Rogue', () => {
    ...
    const rogueSuffixes = ['of the Shadows', 'Whispercloak', 'the Quick', 'Nightstalker', 'Daggerfall', 'Silentblade'];
